...
function Footer() {
  ...
  return (
    <footer className="bg-[#1A1A1A] h-[700px] xl:h-[539px] lg:h-[415px] md:h-[320px] sm:h-[246px] m:h-[189px] w-full px-[100px] xl:px-[77px] lg:px-[59.2px] md:px-[45.5px] sm:px-[35px] m:px-[27px] pb-[143px] xl:pb-[110px] lg:pb-[84.6px] md:pb-[65px] sm:pb-[20px] m:pb-[15px] pt-[77px] xl:pt-[59.2px] lg:pt-[45.5px] md:pt-[35px] sm:pt-[27px] m:pt-[21px] flex justify-between items-start ">
      ...
      <div className="w-[100%] text-content whitespace-nowrap text-white flex-1 ml-24 text-right mt-[28px] xl:mt-[22px] lg:mt-[17px] md:mt-[13px] sm:mt-[10px] m:mt-[7.7px] font-pretendard-regular text-[24px] lg:text-[20px] md:text-[16px] sm:text-[12px]"> {/* flex-1을 사용하여 나머지 공간을 차지하도록 설정 */}
