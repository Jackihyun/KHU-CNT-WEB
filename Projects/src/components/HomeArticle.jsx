          ...
          <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1, y: -130, transition: { delay: 0.5, type: "spring", ease: "easeInOut", duration: 4 }, }}>
            <div className="flex">
              <div className="flex flex-col w-full items-start md:items-center sm:items-center m:items-center">
                ...
                <p className="text-[48px] xl:text-[44px] lg:text-[40px] md:text-[38px] sm:text-[15px] m:text-[14px] mb-[85px] xl:mb-[70px] lg:mb-[55px] md:mb-[40px] sm:mb-[25px] m:mb-[20px] font-['ft-activica-strong'] md:text-center sm:text-center m:text-center">Life is more important than fashion<br />THAT&#39;S WHY FASHION IS IMPORTANT</p>
                <p className="mr-[55px] md:mr-0 sm:mr-0 m:mr-0 text-[18px] xl:text-[16px] lg:text-[14px] md:text-[16px] sm:text-[9px] m:text-[8px] font-['ft-activica-strong'] max-w-[1190px] text-left">
