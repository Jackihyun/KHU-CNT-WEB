    ...
    <>
      <div className="flex">
        <AboutButton
          ...
          content='스테이지 주제'
        />
        <div className='h-[1px] border-[#000] basis-full border-t-2 my-auto relative bottom-[45px] xl:bottom-[38px] lg:bottom-[31px] md:bottom-[27px] sm:bottom-[24px] m:bottom-[15px]' />
        <AboutButton
          link='/about/thanksto'
