    ...
    <>
      <div className="flex">
        <AboutButton
          ...
          content='스테이지 주제'
        />
        <div className='h-[1px] border-[#000] basis-full border-t-2 my-auto relative bottom-[60px] xl:bottom-[50px] lg:bottom-[40px] md:bottom-[30px] sm:bottom-[20px] m:bottom-[10px]' />
        <AboutButton
          link='/about/thanksto'
