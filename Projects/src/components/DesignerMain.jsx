...
function DesignerMain() {
  ...
  return (
    <div className="flex flex-col w-full h-full">
      ...
      <div className=" bg-white grid grid-cols-3 md:grid-cols-3 sm:grid-cols-2 m:grid-cols-2 gap-x-6 gap-y-[75px] md:gap-[55px] sm:gap-[55px] m:gap-[45px] mt-[45px] px-[360px] xl:px-[250px] lg:px-[100px] md:px-[50px] sm:px-[20px] m:px-[20px]">
